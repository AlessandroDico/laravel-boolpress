            ...
            <div class="col">
                ...
                action="{{ route('admin.post.update', ['post'=>$post->id]) }}">
                    ...
                    <div class="form-group">
                        ...
                        value="{{ old('title', $post->title) }}" require maxlength="100">
                        @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <input name="subtitle" type="text" class="form-control" placeholder="Enter Subtitle" maxlength="100"
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="text" rows="8" cols="80" placeholder="Enter Content" class="form-control" required>{{ old('text', $post->text) }}</textarea>
                        @error('text')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
